...
function run_multistate_1st_order(aseed)
    ...
    F_sub_states[1,4] = [1,2,4]
    F_sub_states[1,5] = [1,2,3,5]
    F_sub_states[1,6] = [1,3,6]
    F_sub_states[2,4] = [2,4]
    F_sub_states[2,5] = [2,5]
    F_sub_states[3,5] = [3,5]
    F_sub_states[3,6] = [3,6]
    ...
    CartesianIndex(1, 2),
    CartesianIndex(2, 4)]
    F_sub_transitions[1,5] = [
    CartesianIndex(1, 2),
    CartesianIndex(2, 5),
    CartesianIndex(1, 3),
    CartesianIndex(3, 5)]
    F_sub_transitions[1,6] = [
    CartesianIndex(1, 3),
    CartesianIndex(3, 6)]
    F_sub_transitions[2,4] = [CartesianIndex(2, 4)]
    F_sub_transitions[2,5] = [CartesianIndex(2, 5)]
    F_sub_transitions[3,5] = [CartesianIndex(3, 5)]
    F_sub_transitions[3,6] = [CartesianIndex(3, 6)]
